...
class LockedJSONData(FileLock):
    def __init__(self, lock_file: str, save_changes: bool = True):
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self._data != self._initial_data and self._save_changes:
